...
from google.cloud.dataflow_v1beta3.services.metrics_v1_beta3.transports.base import _GOOGLE_AUTH_VERSION
...
def test_metrics_v1_beta3_client_service_account_always_use_jwt_true(transport_class, transport_name):
    with mock.patch.object(service_account.Credentials, 'with_always_use_jwt_access', create=True) as use_jwt:
        creds = service_account.Credentials(None, None, None)
