...
class JobsV1Beta3RestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_aggregated_list_jobs(self, response: jobs.ListJobsResponse) -> jobs.ListJobsResponse:
        ...
        """
        return response
    def pre_check_active_jobs(self, request: jobs.CheckActiveJobsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[jobs.CheckActiveJobsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_check_active_jobs(self, response: jobs.CheckActiveJobsResponse) -> jobs.CheckActiveJobsResponse:
