...
from google.cloud.dataflow_v1beta3.services.snapshots_v1_beta3 import SnapshotsV1Beta3AsyncClient
...
def test_get_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.SnapshotsV1Beta3RestInterceptor, "post_get_snapshot") as post, \
         mock.patch.object(transports.SnapshotsV1Beta3RestInterceptor, "pre_get_snapshot") as pre:
...
def test_delete_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SnapshotsV1Beta3RestInterceptor, "post_delete_snapshot") as post, \
         mock.patch.object(transports.SnapshotsV1Beta3RestInterceptor, "pre_delete_snapshot") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_snapshots_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SnapshotsV1Beta3RestInterceptor, "post_list_snapshots") as post, \
         mock.patch.object(transports.SnapshotsV1Beta3RestInterceptor, "pre_list_snapshots") as pre:
        pre.assert_not_called()
        post.assert_not_called()
