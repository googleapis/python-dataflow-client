...
class FlexTemplatesServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(FlexTemplatesServiceClient).get_transport_class, type(FlexTemplatesServiceClient))
    ...
    async def launch_flex_template(self,
