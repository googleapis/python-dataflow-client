...
@pytest.mark.parametrize("client_class", [
    JobsV1Beta3Client, JobsV1Beta3AsyncClient
])
@mock.patch.object(JobsV1Beta3Client, "DEFAULT_ENDPOINT", modify_default_endpoint(JobsV1Beta3Client))
@mock.patch.object(JobsV1Beta3AsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(JobsV1Beta3AsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (JobsV1Beta3AsyncClient, transports.JobsV1Beta3GrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
async def test_aggregated_list_jobs_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.aggregated_list_jobs(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_create_job_rest_interceptors(null_interceptor):
    transport = transports.JobsV1Beta3RestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.JobsV1Beta3RestInterceptor(),
        )
    client = JobsV1Beta3Client(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobsV1Beta3RestInterceptor, "post_create_job") as post, \
         mock.patch.object(transports.JobsV1Beta3RestInterceptor, "pre_create_job") as pre:
...
def test_get_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobsV1Beta3RestInterceptor, "post_get_job") as post, \
...
def test_update_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobsV1Beta3RestInterceptor, "post_update_job") as post, \
         mock.patch.object(transports.JobsV1Beta3RestInterceptor, "pre_update_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobsV1Beta3RestInterceptor, "post_list_jobs") as post, \
         mock.patch.object(transports.JobsV1Beta3RestInterceptor, "pre_list_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_aggregated_list_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobsV1Beta3RestInterceptor, "post_aggregated_list_jobs") as post, \
         mock.patch.object(transports.JobsV1Beta3RestInterceptor, "pre_aggregated_list_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = jobs.ListJobsRequest.pb(jobs.ListJobsRequest())
        transcode.return_value = {
...
def test_snapshot_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobsV1Beta3RestInterceptor, "post_snapshot_job") as post, \
         mock.patch.object(transports.JobsV1Beta3RestInterceptor, "pre_snapshot_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
